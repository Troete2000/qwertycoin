// Copyright (c) 2012-2016, The CryptoNote developers, The Bytecoin developers, The Karbowanec developers, The Qwertycoin developers
//
...
const size_t   DIFFICULTY_WINDOW_V2                          = DIFFICULTY_WINDOW; //TODO17; // blocks
